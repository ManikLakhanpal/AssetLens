...
This brings up PostgreSQL, Redis, the API (with automatic Prisma migrations on startup), the LangChain service, and the web frontend. See [`docker-compose.yml`](docker-compose.yml) for details.

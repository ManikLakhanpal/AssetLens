...
- ⚙️ **Settings (`/settings`):** View profile; save Binance and/or Zerodha API keys via `PUT /auth/credentials`.
...
- 🛡️ **AuthGuard** wraps the main dashboard so unauthenticated visitors are redirected to `/login`.

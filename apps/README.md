...
- [`api/`](api) — Node.js/Express backend: **JWT auth**, PostgreSQL (Prisma), Redis caching, per-user Binance and Zerodha integrations, portfolio aggregation, and AI proxy endpoints.
...
2. Run Prisma migrations: `cd apps/api && npx prisma migrate dev`
